...
public class Client {
    ...
    public static void main(String [] argv) throws Exception {
		...
		while ( true ) {
		  ...
		  if(toSendMsg.equals("Exit") || toSendMsg.equals("exit")) {
		  ...
		  else if(toSendMsg.equals("Register") || toSendMsg.equals("register")) {
		  ...
		  //argy
		  else if(toSendMsg.equals("Search") || toSendMsg.equals("search")){
		   ...
		   When the user types Bid/bid to the menu an auction ID is required to join an auction room, after the ID is given the user is moved to an auction room  */
		   	else if (toSendMsg.equals("Bid") || toSendMsg.equals("bid")){
			System.out.println("Please enter the auction ID");
			toSendInt = scanner.nextInt();
			sendMsgInt(dataOutStream, toSendInt);
